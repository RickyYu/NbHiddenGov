...
//录入隐患来源
let HAZARD_SOURCE_NAME = ["企业自查","政府部门检查", "中介机构检查","群众举报" ]
let HAZARD_SOURCE_CODE = ["NP_1","NP_2", "NP_3","NP_4" ]

//整改状态
let ZG_STATE_NAME = ["未整改","已整改"]
let ZG_STATE_CODE = ["1332","1327"]
...
let multipleAssociatedData: [[[String: [String]?]]] = [// 数组
    ...
    [ ["人": ["从业人员操作行为"]],
        ["物": ["消防与应急安全","用电安全","生产设备实施","危险化学品","场所环境","辅助动力系统"]],
        ["管理": ["职业卫生现场管理","资质证照","安全生产管理机构及人员","安全生产责任制","安全生产规章制度","安全生产教育培训","安全生产管理基础档案","应急管理","职业卫生","安全操作规程","安全生产投入","特种设备基础管理","相关方基础管理","其他基础管理","特种设备现场管理","职业卫生现场管理","有限空间现场管理","相关方现场管理","其他现场管理"]]
    ]
]
